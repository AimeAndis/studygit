            ...
            if(DATA.status==0){
                ...
                if(blockList != null && blockList.length>0){
                    ...
                    for(var index in blockList){
                        ...
                        htmlStr +='<tr>'
                            +'<td><span class="address-tag" style="cursor: pointer" title="'+rowData.addr+'">'+rowData.addr+'</span></td>'
...
function getQuotaInfoList() {
    ...
    $.ajax({
        url:'../singleStatistics/ListTbTodayStat.json',//URI
        contentType:"application/json;charset=UTF-8",//设置头信息
        type:'post',
        cache:false,
        dataType:'json',
        ...
        success:function(DATA) {
            ...
            if(DATA.status==0){
                ...
                // db_set_cnt
                var db_set_cnt = data.db_set_cnt;
                var myChart1 = echarts.init(document.getElementById('db_set_cnt'));
                ...
                var option1 = {
                    ...
                    xAxis: {
                        type: 'category',
                        boundaryGap: false,
                        data: db_set_cnt.xAxis.data,
                    },
                    yAxis: {
                        type: 'value'
                    },
                    series: db_set_cnt.series,
                };
                myChart1.setOption(option1);


                // db_get_avg
                var db_get_cnt = data.db_get_cnt;
                var myChart2 = echarts.init(document.getElementById('db_get_cnt'));
                ...
                var option2 = {
                    ...
                    xAxis: {
                        type: 'category',
                        boundaryGap: false,
                        data: db_get_cnt.xAxis.data,
                    },
                    yAxis: {
                        type: 'value'
                    },
                    series: db_get_cnt.series,
                };
                myChart2.setOption(option2);

                // tx_exec_avg
                var tx_exec_avg = data.tx_exec_avg;
                var myChart3 = echarts.init(document.getElementById('tx_exec_avg'));
                ...
                var option3 = {
                    ...
                    xAxis: {
                        type: 'category',
                        boundaryGap: false,
                        data: tx_exec_avg.xAxis.data,
                    },
                    yAxis: {
                        type: 'value'
                    },
                    series: tx_exec_avg.series,
                };
                myChart3.setOption(option3);

                // tx_trace_avg
                var tx_trace_avg = data.tx_trace_avg;
                var myChart4 = echarts.init(document.getElementById('tx_trace_avg'));
                ...
                var option4 = {
                    ...
                    xAxis: {
                        type: 'category',
                        boundaryGap: false,
                        data: tx_trace_avg.xAxis.data,
                    },
                    yAxis: {
                        type: 'value'
                    },
                    series: tx_trace_avg.series,
                };
